          ...
          >
            <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
              ...
              <div className="flex justify-between">
                ...
                <ul className="space-y-3">
                  <li>
                    {memberPaymentData[0].firstname}{' '}
                    {memberPaymentData[0].lastname}
                  </li>
                  <li>{memberPaymentData[0].email}</li>
                  <li>{memberPaymentData[0].phone}</li>
                  <li>
                    {memberDataInfo[0].gender === 'm' ? 'Male' : 'Female'}
                  </li>
              ...
              <div className="flex justify-between">
                ...
                <ul className="space-y-3">
                  <li>{memberPrefData[0].flyingfrom}</li>
                  <li>{memberPrefData[0].dietpref}</li>
                  <li>{memberPrefData[0].allergies}</li>
                  <li>{memberPrefData[0].shirtsize}</li>
                  <li>{memberPrefData[0].interests.join(', ')}</li>
                  <li>{memberPrefData[0].specialrequest}</li>
                </ul>
              </div>
            </div>
          </div>
